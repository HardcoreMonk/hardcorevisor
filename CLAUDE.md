...
- 서브커맨드: `vm` (list/create/start/stop), `node` (list), `storage` (pool list/volume list/create), `network` (zone/vnet/firewall list), `device` (list/attach/detach), `cluster` (status/node list/fence)
