...
# Run tests (Rust 82 + Go 111 = 193 tests)
just test

# Start Go Controller + TUI (2 terminals)
just go-run          # Terminal 1: REST :18080 + gRPC :19090
...
just go-run          # Controller: REST :18080 + gRPC :19090
