...
├───────┴─────────┴────────────────────────────────────┤
│  vmcore (Rust staticlib) — 51 FFI functions          │
│  ┌─────────┬──────────┬───────────┬───────────────┐ │
...
# Run tests (Rust 54 + Go 11 = 65 tests)
just test
...
|-----------|----------|---------|
| `vmcore/` | Rust | KVM core staticlib — 51 FFI, kvm_sys ioctl, io_uring engine, virtio-blk, panic barrier |
