...
# Run tests (Rust 70 + Go 15 = 85 tests)
just test
...
|-----------|----------|---------|
| `vmcore/` | Rust | KVM core staticlib — 63 FFI, kvm_sys/kvm_boot, io_uring, virtio-blk+io+net, RBAC, backup, panic barrier |
